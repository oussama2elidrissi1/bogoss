<?php $__env->startSection('title', __('admin.staff_form.create_title')); ?>

<?php $__env->startSection('content'); ?>
<div class="min-h-screen bg-gradient-to-b from-white to-gray-50">
    <section class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="glass-card p-6">
            <h1 class="font-serif text-3xl font-bold mb-6"><?php echo e(__('admin.staff_form.create_title_short')); ?></h1>
            <form method="POST" action="<?php echo e(route('admin.staff.store')); ?>" class="space-y-4">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="btn-primary"><?php echo e(__('pages.common.save')); ?></button>
