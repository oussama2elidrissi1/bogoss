<?php $__env->startSection('title', __('admin.staff_form.edit_title')); ?>

<?php $__env->startSection('content'); ?>
<div class="min-h-screen bg-gradient-to-b from-white to-gray-50">
    <section class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="glass-card p-6">
            <h1 class="font-serif text-3xl font-bold mb-6"><?php echo e(__('admin.staff_form.edit_title_short')); ?></h1>
            <form method="POST" action="<?php echo e(route('admin.staff.update', $staff)); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('admin.staff_form.name')); ?></label>
                    <input type="text" name="name" class="input-field" value="<?php echo e($staff->name); ?>" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('admin.staff_form.roles')); ?></label>
                    <div class="flex flex-col sm:flex-row gap-3">
                        <select id="role-select" class="input-field">
                            <option value=""><?php echo e(__('admin.staff_form.choose_role')); ?></option>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($role); ?>"><?php echo e($role); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="text" id="role-custom" class="input-field" placeholder="<?php echo e(__('admin.staff_form.add_role_placeholder')); ?>">
                        <button type="button" class="btn-secondary" id="add-role-btn"><?php echo e(__('pages.common.add')); ?></button>
                    </div>
                    <div class="flex flex-wrap gap-2 mt-3" id="role-list" data-roles='<?php echo json_encode($staff->role ?? [], 15, 512) ?>'></div>
                    <input type="hidden" name="roles_input" id="roles-input" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('admin.staff_form.specialties')); ?></label>
                    <div class="flex flex-col sm:flex-row gap-3">
                        <select id="specialty-select" class="input-field">
                            <option value=""><?php echo e(__('admin.staff_form.choose_specialty')); ?></option>
                        ...
                        <input type="text" id="specialty-custom" class="input-field" placeholder="<?php echo e(__('admin.staff_form.add_specialty_placeholder')); ?>">
                        <button type="button" class="btn-secondary" id="add-specialty-btn"><?php echo e(__('pages.common.add')); ?></button>
                    </div>
                    <div class="flex flex-wrap gap-2 mt-3" id="specialty-list" data-specialties='<?php echo json_encode($staff->specialties ?? [], 15, 512) ?>'></div>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('admin.staff_form.phone')); ?></label>
                    <input type="text" name="phone" class="input-field" value="<?php echo e($staff->phone); ?>" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('admin.staff_form.availability')); ?></label>
                ...
                <div class="pt-2 border-t border-gray-200">
                    <h2 class="text-sm font-semibold text-gray-800 mb-2"><?php echo e(__('admin.staff_form.payout_title')); ?></h2>
                    <div class="flex flex-col sm:flex-row gap-3 mb-3">
                        <input type="text" id="service-search" class="input-field" placeholder="<?php echo e(__('pages.common.search_service')); ?>">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="btn-primary"><?php echo e(__('pages.common.update')); ?></button>
...
<script>
  (function () {
    ...
    const roles = new Set(JSON.parse(roleList?.dataset?.roles || '[]'));
    const specialties = new Set(JSON.parse(specialtyList?.dataset?.specialties || '[]'));
