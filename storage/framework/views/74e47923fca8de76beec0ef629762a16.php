    ...
    <section class="gradient-wellness py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-white">
                ...
                <p class="text-xl">Welcome <?php echo e($partner->name); ?></p>
            </div>
        </div>
    </section>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="glass-card p-6">
                ...
                <p class="text-3xl font-bold text-gray-900">$<?php echo e(number_format($totalCommission, 2)); ?></p>
            </div>
            <div class="glass-card p-6">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('partner.bookings.create')); ?>" class="btn-secondary">New Booking</a>
        </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($booking->date->format('M d, Y')); ?> at <?php echo e($booking->time); ?></p>
                            </div>
                            <div class="text-right">
                                <span class="badge badge-primary">$<?php echo e($booking->price); ?></span>
                                <p class="text-sm text-gray-600">Commission: $<?php echo e($booking->commission_amount); ?></p>
                            </div>
                        </div>
                    </div>
