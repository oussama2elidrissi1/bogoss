...
<?php $__env->startSection('title', 'Register - Bogos Land Wellness'); ?>

<?php $__env->startSection('content'); ?>
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div class="glass-card p-8">
            <h2 class="font-serif text-3xl font-bold text-center mb-6">Create Account</h2>
            ...
            <p class="mt-4 text-center text-sm text-gray-600">
                Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-primary hover:underline">Sign In</a>
            </p>
        </div>
    </div>
</div>
