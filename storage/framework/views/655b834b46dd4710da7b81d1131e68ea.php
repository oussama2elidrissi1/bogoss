    ...
    <section id="cart" class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div class="glass-card p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="font-serif text-2xl font-bold text-gray-900">Shopping Cart (<?php echo e($cartItemsCount); ?>)</h2>
            </div>
            ...
            <?php if($cart->count() > 0): ?>
                    ...
                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center space-x-4 bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">$<?php echo e($item['price']); ?> each</p>
                            </div>
                            ...
                            <div class="text-right">
                                <p class="font-bold text-primary">$<?php echo e(number_format($item['price'] * $item['quantity'], 2)); ?></p>
                ...
                <div class="border-t border-gray-200 pt-4">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-2xl font-bold text-primary">$<?php echo e(number_format($cartTotal, 2)); ?></span>
                    </div>
