        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                <div class="mb-8">
                    ...
                    <div class="flex flex-wrap gap-3 mb-6">
                        <a href="<?php echo e(route('booking', ['category' => 'All', 'date' => $selectedDate->toDateString()])); ?>" class="px-6 py-2 rounded-full font-medium transition-all duration-300 <?php echo e($selectedCategory === 'All' ? 'bg-primary text-white shadow-lg scale-105' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'); ?>"><?php echo e(__('pages.common.all')); ?></a>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('booking', ['category' => $category, 'date' => $selectedDate->toDateString()])); ?>" class="px-6 py-2 rounded-full font-medium transition-all duration-300 <?php echo e($selectedCategory === $category ? 'bg-primary text-white shadow-lg scale-105' : 'bg-white text-gray-700 hover:bg-gray-100 border border-gray-200'); ?>"><?php echo e($category); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="glass-card overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <?php if($serviceOptions->count() > 0): ?>
                                        <p class="text-xs text-gray-500 mb-2">✨ <?php echo e($serviceOptions->count()); ?> option(s) disponible(s)</p>
                                    <?php endif; ?>
                                    <button
                                        type="button"
                                        ...
                                        data-service-options="<?php echo e(json_encode($serviceOptions->map(function($opt) { return ['id' => $opt->id, 'name' => $opt->name, 'description' => $opt->description, 'price' => (float) $opt->price, 'duration' => $opt->duration, 'is_required' => $opt->is_required, 'max_quantity' => $opt->max_quantity]; })->values())); ?>"
                                    >
            ...
            <div class="space-y-6">
                    ...
                    <form id="booking-form" class="hidden border-t border-gray-200 pt-4 mt-4">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="date" name="date" id="booking-date" class="input-field" value="<?php echo e($selectedDate->toDateString()); ?>" min="<?php echo e(now()->toDateString()); ?>" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <textarea name="notes" id="booking-notes" rows="3" class="input-field" placeholder="<?php echo e(__('pages.booking.notes_placeholder')); ?>"></textarea>
                            </div>
                            <button type="submit" class="btn-primary w-full">
                                <?php echo e(__('pages.booking.confirm_booking')); ?>
                ...
                <div class="glass-card p-6">
                    <h3 class="font-serif text-xl font-bold text-gray-900 mb-4"><?php echo e(__('pages.booking.choose_date')); ?></h3>
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-3xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div class="mb-6">
            ...
            <select id="options-staff-select" class="input-field">
                ...
                <?php $__currentLoopData = $availableStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($staff->id); ?>"><?php echo e($staff->name); ?> - <?php echo e(is_array($staff->role) ? implode(', ', $staff->role) : $staff->role); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    ...
    if (bookingForm) {
      bookingForm.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          submitBtn.textContent = '<?php echo e(__("pages.booking.confirm_booking")); ?>';
        }
      });
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\oussa\Desktop\bogoss\resources\views/pages/booking-new.blade.php ENDPATH**/ ?>