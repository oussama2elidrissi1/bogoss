...
@section('title', __('admin.staff_form.edit_title'))

@section('content')
<div class="min-h-screen bg-gradient-to-b from-white to-gray-50">
    <section class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="glass-card p-6">
            <h1 class="font-serif text-3xl font-bold mb-6">{{ __('admin.staff_form.edit_title_short') }}</h1>
            <form method="POST" action="{{ route('admin.staff.update', $staff) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mt-3" id="role-list" data-roles='@json($staff->role ?? [])'></div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mt-3" id="specialty-list" data-specialties='@json($staff->specialties ?? [])'></div>
                ...
                <div class="flex gap-3">
                    <button type="submit" class="btn-primary">{{ __('pages.common.update') }}</button>
