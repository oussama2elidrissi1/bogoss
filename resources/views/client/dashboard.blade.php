...
@section('title', 'My Dashboard - Bogos Land Wellness')
    ...
    <section class="gradient-wellness py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-white">
                <h1 class="font-serif text-4xl font-bold mb-2">Welcome back, {{ $user->name }}!</h1>
            ...
            <div class="glass-card p-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900">${{ $clientProfile->total_spent ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div class="bg-gray-50 rounded-lg p-4">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">with {{ $booking->staff_name ?? 'Any Available' }}</p>
                                        </div>
            ...
            <div class="space-y-6">
                <div class="glass-card p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ $clientProfile->phone ?? 'N/A' }}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-medium text-gray-900">{{ $clientProfile->subscription ?? 'No active membership' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-card p-6">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('booking') }}" class="block w-full text-left px-4 py-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">📅 Book New Appointment</a>
                        <a href="{{ route('subscriptions') }}" class="block w-full text-left px-4 py-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">💳 View Membership Plans</a>
                        <a href="{{ route('shop') }}" class="block w-full text-left px-4 py-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">🛍️ Shop Products</a>
                    </div>
                </div>
            </div>
        </div>
